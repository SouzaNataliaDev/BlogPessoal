...
public class UsuarioController {
	 ...
	 * um novo usuário na API. O método da classe Controladora verifica se 
	 * foi possível cadastrar o usuario.
	 * 
	 *Se o cadastro for bem sucedido., os dados do usuário são 
	 * exibidos.
	 */
	 ...
	 * 
	 * Se a atualização for bem sucedida, os dados do usuário 
